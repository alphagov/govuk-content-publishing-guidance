...
/**
 * Website back to top link - from https://github.com/alphagov/govuk-design-system/blob/main/src/javascripts/components/back-to-top.mjs
 */
class BackToTop extends Component {
  ...
  constructor($module) {
    ...
    const $subNav = document.querySelector('.x-govuk-sub-navigation')
