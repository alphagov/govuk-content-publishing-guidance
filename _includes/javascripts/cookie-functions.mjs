// from https://github.com/alphagov/govuk-design-system/blob/main/src/javascripts/components/cookie-functions.mjs
...
const TRACKING_PREVIEW_ID = 'VBLT2V3FZR'
const TRACKING_LIVE_ID = 'S5RQ7FTGVR'
...
const COOKIE_CATEGORIES = {
   ...
   * to be added here.
   */
  essential: ['content_and_publishing_guidance_policy']
}
