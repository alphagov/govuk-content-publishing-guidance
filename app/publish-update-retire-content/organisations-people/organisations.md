...
description: Learn how to publish and edit organisation pages.
lastUpdated:
---
...
* organisations that have changed name (for example, Department for Levelling Up, Housing and Communities to Ministry of Housing, Communities and Local Government)
...
* ‘news priority’ (formerly called ‘top tasks’), with up to 5 links
* ‘service priority’ (formerly called ‘featured services and guidance’), with up to 10 links
...
* in the body, lead with a ‘responsibilities’ section with a short bullet point list of your responsibilities
* include a section for your priorities - it’s best if you take your main priorities from your business plan, as these are normally specific, clear and succinct
...
2. You should see a ‘[Translation] account’ option under the ‘English account’ option. Select ‘Edit’ next to it.
