...
- it's only going to be useful for a short time – if so, it will be better dealt with in a [news article](/publish-update-retire-content/standard-content-types/news-articles)
...
> [!NOTE]
> You can also update your organisation's default lead image. Read the [guidance on updating organisation pages](/publish-update-retire-content/organisations-people/organisations/) for instructions.
