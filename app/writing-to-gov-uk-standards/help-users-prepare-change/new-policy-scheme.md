...
Guidance on how to prepare for the change should not include more than 1 or 2 sentences about the policy itself. If you are describing the policy, you do not need to include:

- why the policy exists (the problem being solved)
